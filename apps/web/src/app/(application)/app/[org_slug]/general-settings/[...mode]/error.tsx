...
// import { usePostHog } from "posthog-js/react" // eslint-disable-line @typescript-eslint/no-unused-vars
...
/**
 * Error Boundary for General Settings
 *
 * Catches errors that occur in the general settings section.
 */
export default function GeneralSettingsError({
  ...
  const handleGoHome = () => {
    router.push(`/app/${org_slug}/settings`)
  }
    ...
    <Center h="100%" p="md" mih="50vh">
      <Stack align="center" gap="lg" maw={500}>
        ...
        <Text c="dimmed" ta="center" size="sm">
          We encountered an error with the settings. Please try again or talk
