...
export const mantinePreset: Config = {
  content: [
    // all . src files
    "./src/**/*.{js,ts,jsx,tsx}"
  ],
    ...
    extend: {
      ...
      colors: {
        mtn: {
          ...
          // Data Table Colors
          "data-table-tr-row-background-color":
            "var(--data-table-tr-row-background-color)",
          "data-table-tr-row-background-color-hover":
            "var(--data-table-tr-row-background-color-hover)",
          "data-table-tr-row-background-color-selected":
            "var(--data-table-tr-row-background-color-selected)",
          "data-table-tr-row-background-color-selected-hover":
            "var(--data-table-tr-row-background-color-selected-hover)",
          "data-table-th-background-color":
            "var(--data-table-th-background-color)",
          "data-table-th-background-color-hover":
            "var(--data-table-th-background-color-hover)",
          "data-table-th-background-color-selected":
            "var(--data-table-th-background-color-selected)",
          "data-table-th-background-color-selected-hover":
            "var(--data-table-th-background-color-selected-hover)",
          primary: {
